...
const { getHorarios_maestros, getHorarios_maestroById, createHorarios_maestro, updateHorarios_maestro, deleteHorarios_maestro,viewTheachersClassInSameHour, testX} = require('../controllers/horarios_maestro.controller');
